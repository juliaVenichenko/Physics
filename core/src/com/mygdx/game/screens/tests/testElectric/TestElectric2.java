...
public class TestElectric2 implements Screen, InputProcessor {
    MyGdxGame myGdxGame;
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonRedFont, 40, 290, "Какое количество теплоты" + "\n" +
                "выделится в резисторе с" + "\n" +  "сопротивлением 5 Ом, через" + "\n" +  "который проходит ток" + "\n" +  "силой 3 А в течение 10 секунд?");

        text2 = new TextView(myGdxGame.commonRedFont, 480, 370, "Что такое линза?");

        textTask1 = new TextView(myGdxGame.commonWhiteFont, 450, 280, "Непрозрачное тело," + "\n" +  "отражающее световые лучи.");
        textTask2 = new TextView(myGdxGame.commonWhiteFont, 450, 210, "Прибор для измерения силы" + "\n" + "тока.");
        textTask3 = new TextView(myGdxGame.commonWhiteFont, 450, 130, "Прозрачное тело," + "\n" + "ограниченное двумя" + "\n" + "сферическими поверхностями");
        textTask4 = new TextView(myGdxGame.commonWhiteFont, 450, 60, "Вещество, не проводящее" + "\n" + "электрический ток.");

...
public class TestElectricFinish implements Screen {
    MyGdxGame myGdxGame;
    ...
    public void show() {
        ...
        textResult = new TextView(myGdxGame.commonRedFont, 280, 390, "Твой результат: " + GameSettings.ELECTRIC_TEST_COUNTER + " из 4!");

...
public class TestThermal2 implements Screen, InputProcessor {
    MyGdxGame myGdxGame;
    ...
    public void show() {
        ...
        btnFilled1 = new ImageView(420, 250, 30, 30, "button_filled.png");
        btnFilled2 = new ImageView(420, 190, 30, 30, "button_filled.png");
        btnFilled3 = new ImageView(420, 130, 30, 30, "button_filled.png");
        btnFilled4 = new ImageView(420, 80, 30, 30, "button_filled.png");

        btnFilledNot1 = new ImageView(420, 250, 30, 30, "button_filledNot.png");
        btnFilledNot2 = new ImageView(420, 190, 30, 30, "button_filledNot.png");
        btnFilledNot3 = new ImageView(420, 130, 30, 30, "button_filledNot.png");
        btnFilledNot4 = new ImageView(420, 80, 30, 30, "button_filledNot.png");
        ...
        textTask1 = new TextView(myGdxGame.commonWhiteFont, 460, 260, "Q = m * g * t(дельта)");
        textTask2 = new TextView(myGdxGame.commonWhiteFont, 460, 200, "Q = m * L");
        textTask3 = new TextView(myGdxGame.commonWhiteFont, 460, 140, "Q = m * g * h");
        textTask4 = new TextView(myGdxGame.commonWhiteFont, 460, 80, "Q = r * m");

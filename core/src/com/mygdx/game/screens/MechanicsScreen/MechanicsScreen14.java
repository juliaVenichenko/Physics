...
public class MechanicsScreen14 implements Screen {
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonRedFont, 320, 410, "ЯВЛЕНИЕ ИНЕРЦИИ");
        text2 = new TextView(myGdxGame.commonWhiteFont, 30, 330, "Инерция - свойство тел сохранять своё состояние неизменным.");
        text3 = new TextView(myGdxGame.commonWhiteFont, 30, 240, "Движение по инерции - движение тела, происходящее без" + "\n" +
                "внешних воздействий.");
        text4 = new TextView(myGdxGame.commonWhiteFont, 30, 100, "Инерциальная система отсчёта (ИСО) - система отсчёта, где" + "\n" +
                "тело, на которое не действуют внешние силы (или действие сил" + "\n" +
                "скомпенсировано), движется бесконечно долго, прямолинейно и" + "\n" + "равномерно или покоится.");
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound11.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound11.play();
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound11.dispose();

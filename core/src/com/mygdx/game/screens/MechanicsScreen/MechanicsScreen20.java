...
public class MechanicsScreen20 implements Screen {
    MyGdxGame myGdxGame;
    ...
    public MechanicsScreen20(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text2 = new TextView(myGdxGame.commonWhiteFont, 30, 300, "Деформацией называют изменение формы, размеров или объёма" + "\n" +
                "тела.");
        text3 = new TextView(myGdxGame.commonRedFont, 310, 220, "СИЛА УПРУГОСТИ");
        text4 = new TextView(myGdxGame.commonWhiteFont, 30, 100, "Упругость - свойство тел изменять форму и размеры под" + "\n" +
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound17.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound17.play();
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound17.dispose();

...
public class MechanicsScreen39 implements Screen {
    MyGdxGame myGdxGame;
    ...
    public MechanicsScreen39(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonRedFont, 375, 390, "ЗВУК");
        text2 = new TextView(myGdxGame.commonWhiteFont, 30, 280, "Звуковые волны или просто звук - волны, воспринимаемые" + "\n" +
                "человеческим ухом.");

        text3 = new TextView(myGdxGame.commonWhiteFont, 30, 160, "Скорость звука - скорость распространения звуковых волн" + "\n" +
                "в среде.");
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound31.stop();
            }
            if (button_left.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.setScreen(myGdxGame.mechanicsScreen38);
                myGdxGame.audioManager.sound31.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound31.play();
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound31.dispose();

...
public class MechanicsScreen34 implements Screen {
    MyGdxGame myGdxGame;
    private Texture background;
    private TextView text1;
    private TextView text2;
    private TextView text3;
    private ButtonView formula_17;
    private ButtonView button_left;
    private ButtonView button_right;
    private ButtonView button_back;
    private ButtonView button_sound;
    public MechanicsScreen34(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text2 = new TextView(myGdxGame.commonRedFont, 265, 330, "ДАВЛЕНИЕ ТВЁРДОГО ТЕЛА");
        ...
        formula_17 = new ButtonView(320, 50, 180, 120, GameResources.FORMULA_17_IMG);
    ...
    public void render(float delta) {
        ...
        formula_17.draw(myGdxGame.batch);
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.setScreen(myGdxGame.mechanicsScreen35);
                myGdxGame.audioManager.sound26.stop();
            }
            if (button_left.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.setScreen(myGdxGame.mechanicsScreen33);
                myGdxGame.audioManager.sound26.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound26.play();
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound26.dispose();

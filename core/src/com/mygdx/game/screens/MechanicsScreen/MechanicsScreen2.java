...
public class MechanicsScreen2 implements Screen {
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonRedFont, 260, 390, "КРИВОЛИНЕЙНОЕ ДВИЖЕНИЕ");
        text2 = new TextView(myGdxGame.commonWhiteFont, 30, 170, "Вращательное - движение в одном направлении по плоской"  + "\n" +
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound2.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound2.play();
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound2.dispose();

...
public class MechanicsScreen3 implements Screen {
    ...
    public void show() {
        ...
        text2 = new TextView(myGdxGame.commonWhiteFont, 30, 280, "  Траектория - воображаемая линия, вдоль которой движется тело." + "\n" + "\n" +
        ...
        text3 = new TextView(myGdxGame.commonWhiteFont, 30, 160, "  Равномерное - движение, при котором тело за равные промежутки времени" + "\n" +

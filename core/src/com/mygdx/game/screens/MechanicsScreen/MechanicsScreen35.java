...
public class MechanicsScreen35 implements Screen {
    MyGdxGame myGdxGame;
    ...
    public MechanicsScreen35(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text2 = new TextView(myGdxGame.commonWhiteFont, 30, 240, "Гидростатическое давление (давление в жидкостях и газах," + "\n" +
                "обусловленное весом) - давление столба жидкости над" + "\n" + "условным уровнем.");
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound27.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound27.play();
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound27.dispose();

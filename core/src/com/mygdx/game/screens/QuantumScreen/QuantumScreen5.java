...
public class QuantumScreen5 implements Screen {
    MyGdxGame myGdxGame;
    private Texture background;
    private TextView text1;
    private TextView text2;
    private TextView text3;
    private ButtonView formula_40;
    private ButtonView button_left;
    private ButtonView button_right;
    private ButtonView button_back;
    private ButtonView button_sound;
    public QuantumScreen5(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonRedFont, 350, 400, "ФОТОНЫ");
        text2 = new TextView(myGdxGame.commonWhiteFont, 30, 290, "Фотон - элементарная частица (электрически нейтральная)," + "\n" +
                "квант электромагнитного излучения.");
        text3 = new TextView(myGdxGame.commonWhiteFont, 30, 180, "Энергия фотона пропорциональна частоте электромагнитного" + "\n" +
                "излучения:");

        formula_40 = new ButtonView(290, 40, 200, 110, GameResources.FORMULA_40_IMG);
    ...
    public void render(float delta) {
        ...
        formula_40.draw(myGdxGame.batch);
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound67.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound67.play();
            }
        }
    }
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound67.dispose();

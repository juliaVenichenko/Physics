...
public class QuantumScreen10 implements Screen {
    MyGdxGame myGdxGame;
    ...
    public QuantumScreen10(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonWhiteFont, 30, 250, "Изотопы - атомы одного и того же химического элемента," + "\n" +
                "имеющие одинаковое число протонов в ядре (зарядовое число Z)" + "\n" +
                "и разное число нейтронов N.");
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound71.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound71.play();
            }
        }
    }
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound71.dispose();

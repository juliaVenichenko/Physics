...
public class ElectricScreen10 implements Screen {
    MyGdxGame myGdxGame;
    private Texture background;
    private TextView text1;
    private TextView text2;
    private ButtonView formula_33;
    private ButtonView button_left;
    private ButtonView button_right;
    private ButtonView button_back;
    private ButtonView button_sound;
    public ElectricScreen10(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonRedFont, 340, 400, "ЗАКОН ОМА");
        text2 = new TextView(myGdxGame.commonWhiteFont, 30, 260, "Сила тока в участке цепи прямо пропорциональна напряжению" + "\n" +
                "на концах проводника и обратно пропорциональна его" + "\n" + "сопротивлению:");

        formula_33 = new ButtonView(305, 40, 190, 160, GameResources.FORMULA_33_IMG);
    ...
    public void render(float delta) {
        ...
        formula_33.draw(myGdxGame.batch);
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound53.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound53.play();
            }
        }
    }
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound53.dispose();

...
public class ElectricScreen18 implements Screen {
    MyGdxGame myGdxGame;
    ...
    public ElectricScreen18(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonRedFont, 280, 400, "ЗАКОН ОТРАЖЕНИЯ СВЕТА");
        text2 = new TextView(myGdxGame.commonWhiteFont, 30, 250, "Угол отражения равен углу падения. Падающий луч, отражённый" + "\n" +
                "луч и перпендикуляр, проведённый в точку падения к отражающей" + "\n" + "поверхности, лежат в одной плоскости.");
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound60.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound60.play();
            }
        }
    }
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound60.dispose();

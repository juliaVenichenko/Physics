...
public class ElectricScreen4 implements Screen {
    MyGdxGame myGdxGame;
    ...
    public ElectricScreen4(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text3 = new TextView(myGdxGame.commonWhiteFont, 30, 150, "Проводник - вещество, способное хорошо проводить электрический" + "\n" + "ток.");
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound47.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound47.play();
            }
        }
    }
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound47.dispose();

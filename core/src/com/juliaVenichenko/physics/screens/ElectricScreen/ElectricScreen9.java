...
public class ElectricScreen9 implements Screen {
    MyGdxGame myGdxGame;
    private Texture background;
    private TextView text1;
    private ButtonView formula_31;
    private ButtonView formula_32;
    private ButtonView button_left;
    private ButtonView button_right;
    private ButtonView button_back;
    private ButtonView button_sound;
    public ElectricScreen9(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonWhiteFont, 30, 310, "Сопротивление проводника зависит от материала, из которого" + "\n" +
                "изготовлен проводник, его длины и сечения:");

        formula_31 = new ButtonView(50, 100, 180, 140, GameResources.FORMULA_31_IMG);
        formula_32 = new ButtonView(270, 75, 470, 190, GameResources.FORMULA_32_IMG);
    ...
    public void render(float delta) {
        ...
        formula_31.draw(myGdxGame.batch);
        formula_32.draw(myGdxGame.batch);
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound52.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound52.play();
            }
        }
    }
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound52.dispose();

...
public class ElectricScreen2 implements Screen {
    MyGdxGame myGdxGame;
    ...
    public ElectricScreen2(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text2 = new TextView(myGdxGame.commonWhiteFont, 30, 285, "Электрический заряд - физическая величина, определяющая" + "\n" +
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound46.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound46.play();
            }
        }
    }
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound46.dispose();

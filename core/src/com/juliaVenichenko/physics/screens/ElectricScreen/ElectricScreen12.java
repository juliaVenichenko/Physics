...
public class ElectricScreen12 implements Screen {
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonRedFont, 280, 400, "ЗАКОН ДЖОУЛЯ - ЛЕНЦА");
        text2 = new TextView(myGdxGame.commonWhiteFont, 30, 260, "Количество теплоты, выделяемое в проводнике с током, равно" + "\n" +
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound55.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound55.play();
            }
        }
    }
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound55.dispose();

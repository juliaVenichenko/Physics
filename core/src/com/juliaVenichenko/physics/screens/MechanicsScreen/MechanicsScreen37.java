...
public class MechanicsScreen37 implements Screen {
    MyGdxGame myGdxGame;
    ...
    public MechanicsScreen37(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonRedFont, 315, 380, "ЗАКОН АРХИМЕДА");
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound29.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound29.play();
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound29.dispose();

...
public class MechanicsScreen29 implements Screen {
    MyGdxGame myGdxGame;
    private Texture background;
    private TextView text1;
    private TextView text2;
    private ButtonView formula_15;
    private ButtonView button_left;
    private ButtonView button_right;
    private ButtonView button_back;
    private ButtonView button_sound;
    public MechanicsScreen29(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonRedFont, 280, 390, "ПОТЕНЦИАЛЬНАЯ ЭНЕРГИЯ");
        text2 = new TextView(myGdxGame.commonWhiteFont, 30, 260, "Потенциальная энергия - это энергия, которую имеет тело" + "\n" +
                "или система тела в зависимости от положения тела" + "\n" + "(системы тела) в пространстве.");

        formula_15 = new ButtonView(280, 80, 250, 100, GameResources.FORMULA_15_IMG);
    ...
    public void render(float delta) {
        ...
        formula_15.draw(myGdxGame.batch);
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.setScreen(myGdxGame.mechanicsScreen30);
                myGdxGame.audioManager.sound23.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound23.play();
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound23.dispose();

...
public class MechanicsScreen24 implements Screen {
    MyGdxGame myGdxGame;
    private Texture background;
    private ButtonView formula_11;
    private ButtonView button_left;
    private ButtonView button_right;
    private ButtonView button_back;
    public MechanicsScreen24(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        formula_11 = new ButtonView(150, 100, 500, 280, GameResources.FORMULA_11_IMG);
    ...
    public void render(float delta) {
        ...
        formula_11.draw(myGdxGame.batch);

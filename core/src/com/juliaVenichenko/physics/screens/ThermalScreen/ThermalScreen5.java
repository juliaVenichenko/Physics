...
public class ThermalScreen5 implements Screen {
    MyGdxGame myGdxGame;
    ...
    public ThermalScreen5(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonRedFont, 290, 390, "ТЕПЛОВОЕ РАВНОВЕСИЕ");
        text2 = new TextView(myGdxGame.commonWhiteFont, 30, 200, "Тепловое равновесие - состояние системы тел, находящихся в" + "\n" +
                "тепловом контакте, при котором не происходит теплопередачи" + "\n" +
                "от одного тела к другому и все макроскопические параметры" + "\n" + "тел остаются неизменными.");
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound38.stop();
            }
            if (button_left.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.setScreen(myGdxGame.thermalScreen4);
                myGdxGame.audioManager.sound38.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound38.play();
            }
        }
    }
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound38.dispose();

...
public class ThermalScreen10 implements Screen {
    MyGdxGame myGdxGame;
    ...
    public ThermalScreen10(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonRedFont, 350, 385, "ИЗЛУЧЕНИЕ");
        text2 = new TextView(myGdxGame.commonWhiteFont, 30, 250, "Излучение - вид теплопередачи, при котором энергия передаётся" + "\n" +
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound43.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound43.play();
            }
        }
    }
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound43.dispose();

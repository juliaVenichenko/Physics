...
public class ThermalScreen2 implements Screen {
    MyGdxGame myGdxGame;
    private Texture background;
    private TextView text1;
    private TextView text2;
    private TextView text3;
    private ButtonView image_2;
    private ButtonView button_left;
    private ButtonView button_right;
    private ButtonView button_back;
    private ButtonView button_sound;
    public ThermalScreen2(MyGdxGame myGdxGame) {
    ...
    public void show() {
        ...
        text1 = new TextView(myGdxGame.commonWhiteFont, 230, 400, "АГРЕГАТНЫЕ СОСТОЯНИЯ ВЕЩЕСТВА");
        text2 = new TextView(myGdxGame.commonRedFont, 330, 330, "ТВЁРДЫЕ ТЕЛА");
        text3 = new TextView(myGdxGame.commonWhiteFont, 30, 230, "В твёрдых телах молекулы совершают беспорядочные колебания" + "\n" +
                "около фиксированных центров (положений равновесия).");

        image_2 = new ButtonView(310, 20, 200, 180, GameResources.IMAGE_2);
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (button_right.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                ...
                myGdxGame.audioManager.sound35.stop();
            }
            ...
            if (button_sound.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
                myGdxGame.audioManager.sound35.play();
    ...
    public void dispose() {
        ...
        myGdxGame.audioManager.sound35.dispose();
